...
class Slim_SEO {
	...
	public static function admin_notices() {
		if ( ! \XMLSF\sitemaps_enabled( 'sitemap' ) || ! \current_user_can( 'manage_options' ) || \in_array( 'slim_seo_sitemap', (array) \get_user_meta( \get_current_user_id(), 'xmlsf_dismissed' ), true ) ) {
			return;
		}
