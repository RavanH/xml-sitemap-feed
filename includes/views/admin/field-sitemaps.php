<fieldset id="xmlsf_sitemaps">
	...
	<label>
        <input type="checkbox" name="<?php echo $this->prefix; ?>sitemaps[sitemap]" id="xmlsf_sitemaps_index" value="sitemap.xml"<?php echo checked(isset($options['sitemap']), true, false); ?> /> 
	...
	<label>
        <input type="checkbox" name="<?php echo $this->prefix; ?>sitemaps[sitemap-news]" id="xmlsf_sitemaps_news" value="sitemap-news.xml"<?php echo checked(isset($options['sitemap-news']), true, false); ?> /> 
