<fieldset id="xmlsf_post_types">
    ...
    <input type="hidden" name="<?php echo $this->prefix; ?>post_types[<?php echo $post_type->name; ?>][name]" value="<?php echo $post_type->name; ?>" />
    <label>
        <input type="checkbox" name="<?php echo $this->prefix; ?>post_types[<?php echo $post_type->name; ?>][active]" id="xmlsf_post_types_<?php echo $post_type->name; ?>" value="1"<?php echo checked( !empty($options[$post_type->name]["active"]), true, false); ?> />
    ...
    <ul class="xmlsf_settings" id="xmlsf_post_types_<?php echo $post_type->name; ?>_settings">
        ...
        <li>
            <label><?php _e('Split by','xml-sitemap-feed'); ?> 
                <select name="<?php echo $this->prefix; ?>post_types[<?php echo $post_type->name; ?>][archive]" id="xmlsf_post_types_'<?php echo $post_type->name; ?>_archive">
                    <option value="">
        ...
        <li>
            <label><?php echo __('Priority','xml-sitemap-feed'); ?> 
                <input type="number" step="0.1" min="0.1" max="0.9" name="<?php echo $this->prefix; ?>post_types[<?php echo $post_type->name; ?>][priority]" id="xmlsf_post_types_<?php echo $post_type->name; ?>_priority" value="<?php echo $priority_val; ?>" class="small-text" />
            </label> 
        ...
        <li>
            <label>
                <input type="checkbox" name="<?php echo $this->prefix; ?>post_types[<?php echo $post_type->name; ?>][dynamic_priority]" value="1"<?php echo checked( !empty($options[$post_type->name]['dynamic_priority']), true, false); ?> /> 
        ...
        <li>
            <label>
                <input type="checkbox" name="<?php echo $this->prefix; ?>post_types[<?php echo $post_type->name; ?>][update_lastmod_on_comments]" value="1"<?php echo checked( !empty($options[$post_type->name]["update_lastmod_on_comments"]), true, false); ?> /> 
        ...
        <li>
            <label>
                ...
                <select name="<?php echo $this->prefix; ?>post_types[<?php echo $post_type->name; ?>][tags][image]">
                    <option value="">
                        <?php echo translate('None'); ?>
                    </option>
