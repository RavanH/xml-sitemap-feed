...
?>
<p>
	<strong><?php esc_html_e( 'Include...', 'xml-sitemap-feed' ); ?></strong>
	<br />
	<?php esc_html_e( 'Activate these to include a post type sitemap in the sitemap index.', 'xml-sitemap-feed' ); ?>
	<?php esc_html_e( 'Make sure that post types are public by following links in the sitemap in an anonymous browser window or after logging out.', 'xml-sitemap-feed' ); ?>
	<?php esc_html_e( 'Some post types or posts may be carrying noindex headers. Make sure to NOT include those post types or posts.', 'xml-sitemap-feed' ); ?>
</p>
<p>
	<strong><?php esc_html_e( 'Split by', 'xml-sitemap-feed' ); ?></strong>
	<br />
...
<p>
	<strong><?php esc_html_e( 'Add image tags for', 'xml-sitemap-feed' ); ?></strong>
	<br />
