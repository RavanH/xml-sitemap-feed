<?php
/**
 * Admin notice: Squirrly SEO news sitemap
 *
...
<div class="notice notice-warning fade is-dismissible">
	<p>
		...
		printf( /* translators: Sitemap page name (linked to Squirrly SEO plugin settings), XML Sitemap Index, Reading Settings admin page (linked to Reading settings) */
			...
			'<a href="' . esc_url( admin_url( 'admin.php' ) ) . '?page=sq_seosettings&tab=tweaks">' . esc_html__( 'Tweaks And Sitemap', 'squirrly-seo' ) . '</a>',
	...
	<form action="" method="post">
		...
		<p>
			<input type="hidden" name="xmlsf-dismiss" value="squirrly_seo_sitemap_news" />
