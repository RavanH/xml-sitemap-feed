...
<div class="wrap">
	...
	<p>
		...
		<?php printf( /* translators: Writing Settings URL */ esc_html__( 'For ping options, go to %s.', 'xml-sitemap-feed' ), '<a href="' . esc_attr( admin_url( 'options-writing.php' ) ) . '#xmlsf_ping">' . esc_html( translate( 'Writing Settings' ) ) . '</a>' ); ?>
	</p>
