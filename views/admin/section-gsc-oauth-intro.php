...
?>
<p>
	<?php \esc_html_e( 'To allow sitemap data retrieval and submission, a connection between your website and Google Search Console needs to be created. This will be set up in two stages: (1) Creating a Google Cloud Console project with OAuth credentials and (2) Authorizing the connection.', 'xml-sitemap-feed' ); ?>
	<?php
	\printf(
