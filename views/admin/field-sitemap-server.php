...
<fieldset id="xmlsf_sitemap_server">
	...
	<p class="description">
		<?php
		printf( /* translators: Site Health admin page, linked */ esc_html__( 'It appears the WordPress core server is not available. Please use the alternative XML sitemap server or upgrade to %s.', 'xml-sitemap-feed' ), '<a href="https://wordpress.org/download/releases/" target="_blank">' . esc_html__( 'WordPress version 5.5+', 'xml-sitemap-feed' ) . '</a>' );
		?>
	</p>
		<?php
	}
