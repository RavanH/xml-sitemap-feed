<fieldset id="xmlsf_taxonomy_settings">
	...
	<p>
		<label>
			...
			<input type="number" step="100" min="0" max="50000" name="xmlsf_taxonomy_settings[limit]" id="xmlsf_taxonomy_limit" value="<?php echo ( isset($taxonomy_settings['limit']) ? $taxonomy_settings['limit'] : '' ); ?>" class="medium-text" />
		</label>
	</p>
</fieldset>
