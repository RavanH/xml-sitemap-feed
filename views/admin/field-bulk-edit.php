	...
	<div class="inline-edit-col column-<?php echo esc_attr( $column_name ); ?>">
		<label class="inline-edit-group">
			...
			<select name="xmlsf_exclude">
				...
				<option value="1"<?php disabled( $disabled ); ?>><?php esc_html_e( 'Exclude all', 'xml-sitemap-feed' ); ?></option>
				<option value="0"<?php disabled( $disabled ); ?>><?php esc_html_e( 'Include all', 'xml-sitemap-feed' ); ?></option>
			</select>
			<?php
			if ( $disabled ) {
